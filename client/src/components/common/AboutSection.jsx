        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-[#103d5d] text-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
                <div className="text-4xl font-bold mb-2">2010</div>
                <p className="text-blue-100">Year Established</p>
              </div>
              <div className="bg-[#245684] text-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
                <div className="text-4xl font-bold mb-2">95%</div>
                <p className="text-blue-100">Student Satisfaction</p>
              </div>
              <div className="bg-white border border-[#245684] text-[#103d5d] p-6 rounded-lg shadow-md transform hover:scale-105 transition duration-300">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 text-center">
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-[#245684]">15K+</div>
                <div className="text-sm text-gray-600">Students</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-[#245684]">500+</div>
                <div className="text-sm text-gray-600">Courses</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-[#245684]">200+</div>
          ...
          <div className="lg:w-1/2">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <button className="px-6 py-3 bg-[#245684] hover:bg-[#1a4066] text-white rounded-md shadow-md transition duration-300">
                Learn More About Us
              </button>
              <button className="px-6 py-3 border border-[#245684] text-[#245684] hover:bg-[#245684] hover:text-white rounded-md transition duration-300">
                View Our Courses
              </button>
            </div>
          </div>
